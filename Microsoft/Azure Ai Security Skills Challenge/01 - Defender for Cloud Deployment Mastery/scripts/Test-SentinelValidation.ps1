...
Write-Host "🔍 Step 1: Validating Log Analytics Workspace..." -ForegroundColor Green
try {
...
Write-Host "🔍 Step 2: Validating Microsoft Sentinel onboarding..." -ForegroundColor Green
...
Write-Host "🔍 Step 3: Validating Defender for Cloud solution and connector status..." -ForegroundColor Green
try {
