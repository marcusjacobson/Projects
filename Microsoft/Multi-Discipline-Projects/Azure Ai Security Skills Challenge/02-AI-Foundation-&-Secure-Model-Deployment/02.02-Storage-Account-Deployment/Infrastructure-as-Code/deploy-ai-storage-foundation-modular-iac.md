...
1. **[Deploy Azure OpenAI Service](../../02.03-Azure-OpenAI-Service-Deployment/Infrastructure-as-Code/deploy-azure-openai-service-iac.md)** - Add AI capabilities
...
3. **[AI Prompt Templates Creation](../../02.05-AI-Prompt-Templates-Creation/ai-prompt-templates.md)** - Complete Week 2 AI foundation
