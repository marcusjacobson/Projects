...
- [ ] **[Prerequisites & Environment Validation](./00.01-Prerequisites-&-Environment-Validation/README.md)** - Verify Azure subscription access, permissions, and regional requirements.
- [ ] **[Development Environment Setup](./00.02-Development-Environment-Setup/README.md)** - Install and configure Azure CLI, PowerShell, Visual Studio Code, and essential extensions.
- [ ] **[Azure Cost Fundamentals & Budget Setup](./00.03-Azure-Cost-Fundamentals-&-Budget-Setup/README.md)** - Configure budget controls, cost monitoring, and resource lifecycle management.
- [ ] **[Troubleshooting & Resources](./00.04-Troubleshooting-&-Resources/README.md)** - Access essential troubleshooting guidance and support resources for foundational setup.
- [ ] **[Week 00 to Week 1 Bridge](./00.05-Week-00-to-Week-1-Bridge/README.md)** - Validate environment readiness and prepare for Defender for Cloud deployment.
...
**Week 01**: [Defender for Cloud Deployment Foundation](../01-Defender-for-Cloud-Deployment-Foundation/README.md)
...
3. **Module 00.05**: Execute bridge validation: Complete [Week 00 to Week 1 Bridge](./00.05-Week-00-to-Week-1-Bridge/README.md)
...
1. **Proceed to Week 1**: [Defender for Cloud Deployment Foundation](../01-Defender-for-Cloud-Deployment-Foundation/README.md)
