...
1. **[AI Model Customization](../../02.04-OpenAI-Model-Customization/customize-openai-model.md)** - Configure security-focused AI model parameters.
2. **[AI Prompt Templates](../../02.05-AI-Prompt-Templates-Creation/ai-prompt-templates.md)** - Create cost-optimized prompt templates for security scenarios.
