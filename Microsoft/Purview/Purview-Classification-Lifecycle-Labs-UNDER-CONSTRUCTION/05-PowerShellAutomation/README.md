# Lab 5: PowerShell Automation for Purview Operations
...
```powershell
# Navigate to Lab 5 scripts directory
cd "C:\REPO\GitHub\Projects\Microsoft\Purview\Purview-Classification-Lifecycle-Labs\05-PowerShellAutomation\scripts"
...
```powershell
# Navigate to Lab 5 scripts directory (if not already there)
cd "C:\REPO\GitHub\Projects\Microsoft\Purview\Purview-Classification-Lifecycle-Labs\05-PowerShellAutomation\scripts"
...
Congratulations on completing Lab 5! You've built enterprise-grade automation capabilities for Microsoft Purview operations. Here's what comes next:

### Lab 6: Runbooks and Operational Documentation

**Proceed to [Lab 6: Runbook Documentation](../06-Runbooks/README.md)** to learn:

- **Deployment Runbooks**: End-to-end procedures for Purview deployment in new tenants.
- **Classification Workflow Documentation**: Best practices for classification and labeling workflows.
- **Retention Policy Implementation Guide**: Lifecycle management procedures and governance.
- **Troubleshooting Knowledge Base**: Common scenarios and resolution steps for operational support.
- **Operational Handoff Checklist**: Complete documentation for IT teams maintaining Purview environments.

Lab 6 provides comprehensive operational documentation that references all previous labs (0-5), enabling smooth operational handoff and enterprise support.

### Integration with Labs 0-4

The automation scripts you've created in Lab 5 integrate seamlessly with the foundational knowledge from previous labs:

- **Lab 0 Integration**: Automation scripts can validate prerequisites and setup established in Lab 0.
- **Lab 1 Integration**: Bulk SIT creation scripts scale the regex-based SIT patterns from Lab 1 to enterprise deployments.
- **Lab 2 Integration**: EDM automation extends Lab 2's exact data match concepts to multiple data sources.
- **Lab 3 Integration**: Bulk classification scripts leverage the on-demand classification validation patterns from Lab 3.
- **Lab 4 Integration**: Bulk label application applies Lab 4's retention concepts at enterprise scale across multiple sites.
