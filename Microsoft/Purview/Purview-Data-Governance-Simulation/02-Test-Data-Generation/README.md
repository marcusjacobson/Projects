...
| **International Banking Account Number** | Financial | High | GB29NWBK60161331926819 |
...
cd "c:\REPO\GitHub\Projects\Microsoft\Purview\Purview-Data-Governance-Simulation\02-Test-Data-Generation"
...
- [ ] **HR Documents Generated**: Files created in generated-documents/HR directory
- [ ] **Financial Documents Generated**: Files created in generated-documents/Finance directory
- [ ] **Identity Documents Generated**: Files created in generated-documents/Identity directory
- [ ] **Mixed-Format Documents Generated**: Files created in generated-documents/Mixed directory
...
- [ ] **Generation Reports Created**: JSON reports saved to reports/ directory
...
1. **Verify Document Generation**:
   - Check `generated-documents/` directory for all four document categories (HR, Finance, Identity, Mixed)
...
3. **Prepare for Lab 03**:
   - Documents remain in local `generated-documents/` directory
...
✅ Generation reports saved in `reports/` directory with JSON metadata  
✅ Documents stored locally in `generated-documents/` directory  
✅ No disk space or PowerShell errors encountered  
✅ Ready to proceed to Lab 03 for SharePoint upload and distribution

---

*This lab establishes the local test data foundation required for Lab 03 document upload, Lab 04 classification validation, and subsequent DLP policy testing and monitoring activities in the Purview Data Governance Simulation.*
