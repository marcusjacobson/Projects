...
$projectStats = @{
    ProjectName = "Purview Data Governance Simulation"
...
if ($OutputFormat -eq "Markdown" -or $OutputFormat -eq "All") {
    ...
    $markdownContent = @"
# Microsoft Purview Data Governance Simulation
...
*Purview Data Governance Simulation Project*
"@
...
<head>
    ...
    <title>Purview Data Governance Simulation - Final Summary</title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1>Microsoft Purview Data Governance Simulation</h1>
...
"@
    ...
    <div class="footer">
        <p>Microsoft Purview Data Governance Simulation</p>
