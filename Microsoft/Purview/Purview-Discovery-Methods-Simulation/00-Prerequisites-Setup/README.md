...
This lab validates that your environment meets all requirements for the Purview Discovery Methods Simulation project and initializes the necessary directory structure.
...
| **AdminCenterUrl** | Your SharePoint admin center URL | N/A (read-only reference) | `https://contoso-admin.sharepoint.com` |
| **ComplianceUrl** | Your Security & Compliance center URL | N/A (read-only reference) | `https://compliance.microsoft.com` |
| **OrganizationName** | Your organization name | N/A (label only) | `Contoso Corporation` |
...
> **💡 Scale Impact**:
>
> | ScaleLevel | Documents | Storage | Generation Time | Use Case |
> |------------|-----------|---------|-----------------|----------|
> | `Small` | 1,000 | ~1 GB | 5-10 min | Quick testing, demos |
...
| **Description** | Site description for metadata | Any descriptive string | N/A (label only) | `HR department simulation site` |
...
=======================================
   ...
   ✅ PowerShell 7+ detected (optimal performance)

🔍 Step 2: Validate Required PowerShell Modules
================================================
   📋 Checking PnP.PowerShell module...
   ✅ PnP.PowerShell module found: v3.1.0
   📋 Checking ExchangeOnlineManagement module...
   ✅ ExchangeOnlineManagement module found: v3.9.0
...
=====================================
   📋 Testing Compliance Center connection (for Lab 05 DLP features)...
   🌐 Connecting to Security & Compliance Center...
   ✅ Security & Compliance Center: Connected successfully
   📋 Connecting to SharePoint...
   ✅ SharePoint connection established successfully
   ✅ SharePoint Online: Connected to: https://yourtenant.sharepoint.com
...
========================================
   ✅ Parent directory accessible: LogDirectory
   ✅ Parent directory accessible: OutputDirectory
   ✅ Parent directory accessible: GeneratedDocumentsPath
   ✅ Parent directory accessible: ReportsPath

🔍 Step 7: Prerequisites Validation Summary
============================================
   ✅ All prerequisites validation checks passed
   ✅ Environment ready for Purview Discovery Methods Simulation

🎯 Next Steps:
   1. Run Initialize-SimulationEnvironment.ps1 to create directories
   2. Proceed to Lab 01 to create SharePoint sites
```

> **🔐 Authentication Note**: The script will prompt for authentication twice - once for Security & Compliance Center and once for SharePoint. Browser windows will open automatically for Microsoft 365 sign-in. Ensure you sign in with an account that has **SharePoint Administrator** and **Compliance Administrator** roles.
...
Initialize the simulation environment to create directory structure:
...
======================================
   ...
   ...
   📊 Summary: Created 4 directories, Found 0 existing
...
🔍 Step 4: Create Environment Information File
===============================================
   ✅ Environment information saved: environment-info.json

🔍 Step 5: Initialization Summary
==================================
   ✅ Directory structure initialized
   ✅ Write permissions validated
   ✅ Environment ready for simulation execution

✅ Simulation environment initialization completed successfully
```
...
> **💡 Automatic Document Count**: `TotalDocuments` is automatically derived from `ScaleLevel` in the Simulation section. Simply set your desired `ScaleLevel` - document counts are calculated automatically when configuration loads.
>
...
----                                                  -------- -----------
U.S. Social Security Number (SSN)                     High     Nine-digit number issued to U.S. citizens for tax purposes
Credit Card Number                                    High     16-digit payment card numbers from major issuers
U.S. / U.K. Passport Number                           Medium   Passport identification numbers for international travel
U.S. Driver's License Number                          Medium   State-issued driver's license identification numbers
U.S. Individual Taxpayer Identification Number (ITIN) Medium   Tax processing number for individuals without SSN eligibility
ABA Routing Number                                    Low      Nine-digit code identifying financial institutions
U.S. Bank Account Number                              Low      Account numbers for banking transactions
```
...
## 📚 Adding Additional SITs

This section explains how to extend the simulation with additional Sensitive Information Types beyond the default seven.

### Finding SIT Names

1. **Navigate to Microsoft Purview Compliance Portal**:
   - Go to: [Compliance Portal > Data Classification > Classifiers > Sensitive Info Types](https://compliance.microsoft.com/classificationdefinitions)
...
Add new entries to the `BuiltInSITs` array in `global-config.json`:
...
### Example: EU Data Protection SITs
...
### Example: Pre-Existing Custom SITs
...
### Understanding the Enabled Flag
...
- [ ] **Document generation settings reviewed** - Understand scale and PII density options
...
- ✅ Initialized simulation directory structure
...
You have successfully completed the prerequisites setup and your environment is ready for the Purview Discovery Methods Simulation. Your global configuration is centralized and your directory structure is initialized.
