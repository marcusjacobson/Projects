...
![content-explorer](.images/content-explorer.png)
...
[Insert Screenshot: Content Explorer showing populated SIT counts confirming classification has completed - verify counts are substantial before proceeding to baseline recording]
...
- Open PowerShell
- Navigate to: `C:\REPO\GitHub\Projects\Microsoft\Purview\Purview-Discovery-Methods-Simulation\05-Data-Discovery-Paths`
...
- [ ] **SIT Detection Verified**: All 7 expected SIT types visible (SSN, Credit Card, Bank Account, Passport, Driver's License, ITIN, ABA Routing)
