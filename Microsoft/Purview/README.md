...
This directory contains **two comprehensive hands-on lab projects** designed to build practical Microsoft Purview expertise across different capability areas. Together, these projects provide **extensive coverage** of the Microsoft Purview capability landscape with deep, hands-on implementation experience.

**Combined Learning Value**: 25-35 hours of hands-on lab work covering on-premises scanning, cloud governance, data classification, retention management, discovery automation, and production workflows.
...
> **💡 Important Note**: Both projects are **designed to be completed independently** and do not require each other. Each project provides complete, standalone learning value within its focus area. The combined approaches below maximize the full Purview experience across hybrid, cloud, and discovery automation scenarios, though there will be some intentional overlap in foundational concepts that reinforces learning.

### For Complete Purview Mastery

**Full Sequential Approach** (5-7 weeks total, complexity-based progression):
...
4. **Weeks 4-5**: Complete Data-Governance-Simulation Labs 00-03 (Setup + Document Upload)
...
5. **Weeks 5-6**: Complete Data-Governance-Simulation Labs 04-05 (Classification + Discovery)
...
6. **Weeks 6-7**: Complete Data-Governance-Simulation Lab 05c (API Discovery)
...
**Combined Total**: 25-35 hours active work | **Cost**: $10-140
...
### Coverage Matrix: Two-Project Comparison
...
| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
...
| **eDiscovery Compliance Search** | INTERMEDIATE | ✅ Cloud-04 (KQL queries) | ✅ Lab 05b (24hr modern portal, Cases preview) | ✅ COMPREHENSIVE |
| **Modern eDiscovery Portal** | INTERMEDIATE | Not covered | ✅ Lab 05b (purview.microsoft.com, Condition builder) | ✅ COMPREHENSIVE |
| **Discovery Method Comparison** | INTERMEDIATE | Not covered | ✅ Lab 05 overview (timing/accuracy matrix) | ✅ COMPREHENSIVE |
| **Keyword Dictionaries** | BASIC | Not covered | Not covered | ❌ Not Covered |
| **SIT Confidence Tuning** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **EDM Schema Design** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
| **EdmUploadAgent.exe** | ADVANCED | Not covered | Not covered | ❌ Not Covered |

#### ✅ Data Loss Prevention (DLP)

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **DLP Policies (On-Premises)** | INTERMEDIATE | ✅ OnPrem-03, OnPrem-04 (file share enforcement) | Not covered | ✅ EXTENSIVE |
| **DLP Policies (SharePoint Online)** | INTERMEDIATE | ✅ Supplemental: Advanced-SharePoint-SIT-Analysis (real-time protection) | Not covered | ✅ EXTENSIVE |
| **DLP Policy Sync & Enforcement** | INTERMEDIATE | ✅ OnPrem-04 (1-2 hour sync validation) | Not covered | ✅ COMPREHENSIVE |
| **DLP Reporting & Monitoring** | INTERMEDIATE | ✅ Supplemental: Advanced-Cross-Platform-SIT-Analysis (cross-platform metrics) | Not covered | ✅ COMPREHENSIVE |
| **DLP Policies (Endpoint/Email/Teams)** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
| **Cloud App DLP (non-Microsoft)** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
| **DLP for Power Platform** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
...
| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Retention Labels** | INTERMEDIATE | ✅ Cloud-02 (creation, configuration) | Not covered | ✅ COMPREHENSIVE |
| **Auto-Apply Policies** | INTERMEDIATE | ✅ Cloud-03 (SIT-based triggers) | Not covered | ✅ COMPREHENSIVE |
| **Last Access Time Retention** | INTERMEDIATE | ✅ Cloud-02 (SharePoint-specific trigger) | Not covered | ✅ DETAILED |
| **Retention Simulation Mode** | INTERMEDIATE | ✅ Cloud-02, Cloud-03 (1-2 day validation) | Not covered | ✅ DETAILED |
| **Retention Production Mode** | INTERMEDIATE | ✅ Cloud-02, Cloud-03 (7-day activation) | Not covered | ✅ DETAILED |
| **Label Lifecycle Management** | INTERMEDIATE | ✅ Cloud-02 (creation to enforcement) | Not covered | ✅ EXTENSIVE |
| **Policy Adoption Monitoring** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **File Plan Descriptors** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Disposition Reviews** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Event-based Retention** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Regulatory Records** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |

#### ✅ eDiscovery & Legal

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Content Search (Basic)** | INTERMEDIATE | ✅ Cloud-04 (KQL queries, exports) | ✅ Lab 05b (24hr modern Cases preview) | ✅ COMPREHENSIVE |
| **KQL Query Language** | INTERMEDIATE | ✅ Cloud-04 (SIT-based discovery) | ✅ Lab 05b (Condition builder, metadata) | ✅ COMPREHENSIVE |
| **eDiscovery Export** | INTERMEDIATE | ✅ Cloud-04 (legal export workflows) | ✅ Lab 05b (PST export, reporting) | ✅ COMPREHENSIVE |
| **Discovery Automation** | INTERMEDIATE | Not covered | ✅ Lab 05c (API-based, scheduled) | ✅ COMPREHENSIVE |
| **eDiscovery (Premium)** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
| **Legal Hold** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Custodian Management** | ADVANCED | Not covered | Not covered | ❌ Not Covered |
...
| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **SharePoint Site Configuration** | BASIC | ✅ Cloud-01 (test site creation) | ✅ Lab 01 (5-25 Communication Sites) | ✅ COMPREHENSIVE |
| **Document Upload & Management** | BASIC | ✅ Cloud-01 (sample documents) | ✅ Lab 03 (5000 bulk documents, PnP) | ✅ COMPREHENSIVE |
| **Bulk Document Upload** | INTERMEDIATE | Not covered | ✅ Lab 03 (5000 files, PnP PowerShell) | ✅ COMPREHENSIVE |
| **Indexing Status Validation** | INTERMEDIATE | Not covered | ✅ Lab 05b (Test-ContentIndexingStatus.ps1) | ✅ COMPREHENSIVE |
| **On-Demand Classification Triggers** | INTERMEDIATE | ✅ Supplemental: Advanced-SharePoint-SIT-Analysis | ✅ Lab 04 (7-day portal-based) | ✅ COMPREHENSIVE |
| **Classification Validation** | INTERMEDIATE | ✅ Cloud-01, Supplemental labs (Content Explorer) | ✅ Lab 04 (Content Explorer, 7-day) | ✅ COMPREHENSIVE |

#### ✅ Automation & Scripting

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Security & Compliance PowerShell** | INTERMEDIATE | ✅ All sections (cmdlet operations) | ✅ Labs 04/05a (discovery operations) | ✅ COMPREHENSIVE |
| **PnP PowerShell** | INTERMEDIATE | ✅ Supplemental: Advanced-Remediation (bulk operations) | ✅ Labs 01/03/05a (site creation, bulk upload) | ✅ COMPREHENSIVE |
| **Microsoft Graph PowerShell SDK** | INTERMEDIATE | Not covered | ✅ Lab 05c (OAuth 2.0, delegated permissions) | ✅ EXTENSIVE |
| **Discovery Automation** | INTERMEDIATE | Not covered | ✅ Lab 05c (scheduled scans, SIEM) | ✅ COMPREHENSIVE |
| **Azure CLI** | BASIC | ✅ Setup-02 (infrastructure deployment) | Not covered | ✅ COMPREHENSIVE |
| **Bicep IaC** | INTERMEDIATE | ✅ Setup-02 (Azure resource provisioning) | Not covered | ✅ COMPREHENSIVE |
| **Compliance Content Searches** | INTERMEDIATE | ✅ Cloud-04 (KQL-based searches) | ✅ Lab 05b (modern portal, Cases) | ✅ COMPREHENSIVE |
| **Bulk Operations (Deletion)** | INTERMEDIATE | ✅ Supplemental: Advanced-Remediation (deduplication, tombstones) | Not covered | ✅ COMPREHENSIVE |
| **Bulk Label Application** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Policy Monitoring Scripts** | INTERMEDIATE | Not covered | Not covered | ❌ Not Covered |
| **Compliance Reporting** | INTERMEDIATE | ✅ Supplemental: Advanced-Cross-Platform-SIT-Analysis (executive reports) | ✅ Labs 05a/c (CSV discovery reports) | ✅ COMPREHENSIVE |
| **REST API Integration** | ADVANCED | ✅ Supplemental: Advanced-Remediation (Azure Resource Management) | ✅ Lab 05c (Graph API) | ✅ COMPREHENSIVE |
| **Configuration-Driven Architecture** | INTERMEDIATE | Not covered | ✅ All Labs (single JSON config) | ✅ DETAILED |
| **Browser-Based Authentication** | INTERMEDIATE | Not covered | ✅ All Labs (no secrets required) | ✅ DETAILED |

#### ✅ Azure & Cloud Infrastructure

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Azure VM Deployment** | INTERMEDIATE | ✅ Setup-02 (Windows Server, SQL Express) | Not covered | ✅ COMPREHENSIVE |
| **Azure Resource Management** | INTERMEDIATE | ✅ Setup-02 (resource groups, RBAC) | Not covered | ✅ COMPREHENSIVE |
| **Azure Files Integration** | INTERMEDIATE | ✅ OnPrem-02 (scanner repository) | Not covered | ✅ COMPREHENSIVE |
| **Microsoft Entra ID (Azure AD)** | INTERMEDIATE | ✅ Setup-03 (service accounts, app registration) | ✅ Lab 05c (OAuth 2.0, delegated permissions) | ✅ COMPREHENSIVE |
| **Hybrid Identity Management** | INTERMEDIATE | ✅ Setup-01, Setup-03 (on-prem + cloud) | Not covered | ✅ DETAILED |

#### ✅ Operational Documentation & Runbooks

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Production Deployment Runbooks** | INTERMEDIATE | Integrated throughout all sections | Not covered | ✅ EXTENSIVE |
| **Classification Workflow Docs** | INTERMEDIATE | ✅ Supplemental labs (operational guides) | ✅ Labs 04/05 (discovery workflows) | ✅ COMPREHENSIVE |
| **Troubleshooting Knowledge Base** | INTERMEDIATE | Each lab includes troubleshooting | Each lab includes troubleshooting | ✅ COMPREHENSIVE |
| **Operational Handoff Procedures** | INTERMEDIATE | ✅ Environment cleanup guide | Not covered | ✅ COMPREHENSIVE |

#### ✅ Advanced Production Workflows

| Capability | Complexity | Skills-Ramp Coverage | Data-Governance-Simulation Coverage | Combined Status |
|------------|------------|---------------------|-------------------------------------|-----------------|
| **Production Remediation Workflows** | ADVANCED | ✅ Supplemental: Advanced-Remediation (multi-tier severity) | Not covered | ✅ EXTENSIVE |
| **Dual-source Deduplication** | ADVANCED | ✅ Supplemental: Advanced-Remediation (Activity + Content Explorer) | Not covered | ✅ DETAILED |
| **Progress Tracking Dashboards** | INTERMEDIATE | ✅ Supplemental: Advanced-Remediation (CSV tracking) | Not covered | ✅ DETAILED |
...
### Complete Both Projects When You Want
...
→ Complete Data-Governance-Simulation Labs 00-05, then Skills-Ramp Sections 1-2, then Skills-Ramp Section 3 + Supplemental Labs
...
Completing both projects demonstrates proficiency in:
...
Both projects provide hands-on experience aligned with:
...
| **Combined Total** | **25-35 hours** | **Optimized sequencing** | **$10-140** |

**Recommended Combined Timeline**: 5-7 weeks for complete two-project mastery with full discovery timing validation and production deployment activation periods
...
- [Microsoft Purview Timing Delay Reference Guide](./TIMING-DELAY-CHEAT-SHEET.md) - Comprehensive timing expectations for all Purview operations validated against Microsoft Learn documentation (November 2025). All timing claims across both projects are validated against this authoritative reference.
